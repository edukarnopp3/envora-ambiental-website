...
export const servicePages: ServicePageData[] = [
  ...
  {
    slug: "autorizacao-corte-vegetacao-auc",
    shortTitle: "Autorização para Corte de Vegetação (AuC)",
    title: "A supressão de vegetação começa com autorização.",
    eyebrow: "Levantamento e documentação técnica da AuC",
    description: "Consultoria em Joinville para requerer Autorização para Corte de Vegetação (AuC), com análise do local, documentação técnica e acompanhamento do processo.",
    intro: "Em Joinville, a AuC é o procedimento municipal para requerer a supressão de vegetação nativa em maciços florestais. O enquadramento e os documentos dependem da área e da intervenção proposta.",
    highlights: ["Vegetação caracterizada", "Processo instruído", "Etapas complementares verificadas"],
    applies: "O serviço se aplica a situações em que o projeto prevê supressão de vegetação nativa e exige autorização ambiental. A análise considera localização, área, características da vegetação e finalidade da intervenção.",
    process: [
      "Conferimos a localização, a área e a intervenção pretendida para identificar o procedimento aplicável.",
      "Organizamos o levantamento e os documentos técnicos exigidos para instruir o requerimento.",
      "Acompanhamos as etapas contratadas e verificamos o encaminhamento no Sinaflor previsto após o procedimento municipal.",
    ],
    deliverable: "Enquadramento e documentação técnica organizados para o pedido de AuC, com as etapas do processo definidas conforme o caso.",
    boundary: "A supressão só deve ocorrer após as autorizações e etapas aplicáveis. A emissão da AuC depende da análise do órgão competente.",
    sources: [pmj("Requerer Autorização para Corte de Vegetação (AuC)", "servicos/requerer-autorizacao-para-corte-de-vegetacao-auc/")],
  },
  {
    slug: "projeto-recuperacao-area-degradada-prad",
    shortTitle: "Projeto de Recuperação de Área Degradada (PRAD)",
    title: "Recuperação começa com diagnóstico e projeto técnico.",
    eyebrow: "Projeto de Recuperação de Área Degradada (PRAD)",
    description: "Elaboração de PRAD em Joinville, com diagnóstico da área, definição de medidas de recuperação e documentação para análise do órgão competente.",
    intro: "O PRAD descreve como a área será recuperada e quais medidas, prazos e verificações serão adotados, conforme as condições do local e a exigência que originou a demanda.",
    highlights: ["Área caracterizada", "Medidas de recuperação definidas", "Relatórios previstos organizados"],
    applies: "O PRAD pode ser solicitado em processos relacionados a áreas degradadas ou alteradas. As medidas devem corresponder às condições verificadas no local e às determinações do órgão ambiental.",
    process: [
      "Analisamos o histórico da área, a exigência recebida e os registros já disponíveis.",
      "Caracterizamos as condições do local e definimos medidas técnicas compatíveis com o objetivo de recuperação.",
      "Estruturamos o projeto e os documentos de acompanhamento previstos no procedimento e no escopo contratado.",
    ],
    deliverable: "PRAD estruturado para a área e para a exigência identificada, com medidas e documentação técnica organizadas.",
    boundary: "A aprovação do projeto e a autorização para sua execução cabem ao órgão competente. A implantação e o monitoramento são etapas próprias, incluídas somente quando previstas no escopo.",
    sources: [pmj("Requerer aprovação de Projeto de Recuperação de Área Degradada (PRAD)", "servicos/requerer-aprovacao-de-projeto-de-recuperacao-de-area-degradada-prad/")],
  },
  {
    slug: "autorizacao-corte-arvores-isoladas-cai",
    shortTitle: "Autorização para Corte de Árvores Isoladas (CAI)",
    title: "Árvore isolada também exige autorização.",
    eyebrow: "Caracterização e documentação para CAI",
    description: "Consultoria em Joinville para autorização de corte de árvores isoladas, com avaliação técnica, justificativa e instrução documental conforme o procedimento aplicável.",
    intro: "A Prefeitura de Joinville prevê procedimento próprio para requerer autorização de supressão de árvores isoladas em imóvel particular. A análise depende das características da árvore, da localização e da justificativa apresentada.",
    highlights: ["Árvores caracterizadas", "Justificativa documentada", "Pedido organizado"],
    applies: "O procedimento municipal abrange árvores isoladas nativas ou exóticas em propriedades particulares. Casos associados a risco à vida ou ao patrimônio precisam ser enquadrados conforme as condições verificadas.",
    process: [
      "Levantamos a localização, as características das árvores e a intervenção pretendida.",
      "Organizamos a justificativa e os documentos técnicos e administrativos necessários ao pedido.",
      "Protocolamos e acompanhamos as etapas contratadas, incluindo respostas a complementações técnicas previstas no escopo.",
    ],
    deliverable: "Avaliação e documentação técnica organizadas para o requerimento de autorização de árvores isoladas.",
    boundary: "A autorização depende da análise do órgão e deve ser obtida antes do corte. Em situação de risco iminente de queda, acione a Defesa Civil; a autorização ambiental não substitui o atendimento emergencial.",
    sources: [pmj("Requerer Autorização para Corte de Árvores Isoladas e/ou com risco à vida ou ao patrimônio", "servicos/requerer-autorizacao-para-corte-de-arvores-isoladas-e-ou-com-risco-a-vida-ou-ao-patrimonio/")],
  },
  {
...
export const serviceInputsBySlug: Record<string, string[]> = {
  ...
  "autorizacao-corte-vegetacao-auc": [
    "Localização e identificação do imóvel e da área de intervenção pretendida.",
    "Plantas, levantamentos, registros fotográficos e estudos existentes sobre a vegetação.",
    "Descrição do projeto, da finalidade da intervenção e dos documentos já emitidos pelo órgão, se houver.",
  ],
  "projeto-recuperacao-area-degradada-prad": [
    "Localização e histórico da área, incluindo exigências ou notificações recebidas.",
    "Registros atuais do local, fotografias, levantamentos e estudos anteriores disponíveis.",
    "Objetivo de recuperação, intervenções realizadas e documentos do processo ambiental.",
  ],
  "autorizacao-corte-arvores-isoladas-cai": [
    "Endereço e identificação do imóvel e das árvores avaliadas.",
    "Fotografias e informações disponíveis sobre quantidade, espécie, dimensões e condição das árvores.",
    "Justificativa para a intervenção e documentos ou comunicações anteriores do órgão, se houver.",
  ],
...
export const relatedServiceSlugs: Record<string, string[]> = {
  ...
  "autorizacao-corte-vegetacao-auc": ["autorizacao-corte-arvores-isoladas-cai", "projeto-recuperacao-area-degradada-prad", "diagnostico-e-enquadramento-ambiental"],
  "projeto-recuperacao-area-degradada-prad": ["autorizacao-corte-vegetacao-auc", "autorizacao-corte-arvores-isoladas-cai", "diagnostico-e-enquadramento-ambiental"],
  "autorizacao-corte-arvores-isoladas-cai": ["autorizacao-corte-vegetacao-auc", "projeto-recuperacao-area-degradada-prad", "diagnostico-e-enquadramento-ambiental"],
